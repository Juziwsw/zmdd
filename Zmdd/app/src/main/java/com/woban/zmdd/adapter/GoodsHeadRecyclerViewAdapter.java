 ...
 */
public class GoodsHeadRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public GoodsHeadRecyclerViewAdapter(List<TabRecyItem> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_goodshead_item, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (tabRecyItem.onclicked){
            holder.titleTv.setTextColor(mContext.getResources().getColor(R.color.red));
        }else {
            holder.titleTv.setTextColor(mContext.getResources().getColor(R.color.gray));
        }
    ...
    class PersonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener
    {
        ...
        public PersonViewHolder(View itemView) {
            ...
            rootView = itemView.findViewById(R.id.goodsheadrecyclerviewadapter_lin);
