 ...
 */
public class GoodsListviewAdapter extends ImagesBaseAdapter {

    public GoodsListviewAdapter(Context mContext, List<TabRecyItem> mListData, int mItem) {
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            viewHolder.txtTitile = (TextView) convertView.findViewById(R.id.goods_item_title);
