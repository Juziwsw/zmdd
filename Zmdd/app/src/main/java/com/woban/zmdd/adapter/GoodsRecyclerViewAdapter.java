...
public class GoodsRecyclerViewAdapter  extends RecyclerView.Adapter {
    ...
    public GoodsRecyclerViewAdapter(List<TabRecyItem> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_goods_item, null);
    ...
    class PersonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener
    {
        ...
        public PersonViewHolder(View itemView) {
            ...
            rootView = itemView.findViewById(R.id.goodsrecyclerviewadapter_lin);
