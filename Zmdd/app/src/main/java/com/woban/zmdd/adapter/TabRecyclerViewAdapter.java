 ...
 * 攻略界面上部左右滑动的适配器
 */
public class TabRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public TabRecyclerViewAdapter(List<TabRecyItem> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_tab_item, null);
    ...
    class PersonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener
    {
        ...
        public PersonViewHolder(View itemView) {
            super(itemView);
            imageView = (ImageView) itemView.findViewById(R.id.tab_img);
            titleTv = (TextView) itemView.findViewById(R.id.recyclerView_title1);
            rootView = itemView.findViewById(R.id.tabrecyclerviewadapter_rel);
